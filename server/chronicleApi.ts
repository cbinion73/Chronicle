...
export type ChronicleMiddlewareHost = {
  use: {
...
// Registers routes directly against whatever middleware host is passed in — Vite's
// dev/preview `server.middlewares` and the standalone production server's `connect()`
// app both satisfy ChronicleMiddlewareHost (both are plain connect instances), so the
// exact same registration functions run unmodified in both contexts.
function withChronicleMiddlewares(
  host: ChronicleMiddlewareHost,
...
function apiAuthGate(env: Record<string, string>, host: ChronicleMiddlewareHost) {
...
function chronicleIntegrationDevApi(host: ChronicleMiddlewareHost) {
  withChronicleMiddlewares(host, (middlewares) => {
...
function apiBibleDevApi(env: Record<string, string>, host: ChronicleMiddlewareHost) {
  withChronicleMiddlewares(host, (middlewares) => {
...
function aiChatDevApi(env: Record<string, string>, host: ChronicleMiddlewareHost) {
  withChronicleMiddlewares(host, (middlewares) => {
...
function voiceDevApi(env: Record<string, string>, host: ChronicleMiddlewareHost) {
  withChronicleMiddlewares(host, (middlewares) => {
...
function studyImportsDevApi(env: Record<string, string>, host: ChronicleMiddlewareHost) {
  withChronicleMiddlewares(host, (middlewares) => {
...
function themeAnalysisDevApi(host: ChronicleMiddlewareHost) {
  withChronicleMiddlewares(host, (middlewares) => {
...
export function loadChronicleEnv(mode: string) {
...
export function applyDotEnvFileToProcessEnv(path: string) {
