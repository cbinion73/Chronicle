...
export type RosaryBead = {
  ...
  prayerText?: string;
  /** The physical stone/bead this position uses, per the source doc's stone-mapping table. */
  stoneKey: StoneKey;
};

const DECADE_STONE_CYCLE_A: StoneKey[] = ['jasper', 'topaz', 'carbuncle', 'emerald', 'sapphire', 'diamond', 'amethyst', 'agate', 'onyx', 'beryl'];
const DECADE_STONE_CYCLE_B: StoneKey[] = ['emerald', 'sapphire', 'diamond', 'amethyst', 'agate', 'onyx', 'beryl', 'jasper', 'topaz', 'carbuncle'];
...
const raw: Omit<RosaryBead, 'index'>[] = [
  ...
  },
  {
    ...
    stoneKey: 'centerpiece',
  },
  ...decade('First Decade (Thanksgiving)', 'Express gratitude to God, reflecting on specific blessings with each bead.', DECADE_STONE_CYCLE_A, [
  ...
  ...decade('Second Decade (Scripture Meditation)', 'Meditate on the Word of God, letting it guide and shape your thoughts.', DECADE_STONE_CYCLE_B, [
  ...
  ...decade('Third Decade (Intercession Focus)', 'Pray for various people and groups, lifting them to God with a specific focus for each bead.', DECADE_STONE_CYCLE_A, [
  ...
  ...decade('Fourth Decade (Personal Growth)', 'Ask God to help you grow in specific areas of your walk with Him.', DECADE_STONE_CYCLE_B, [
  ...
  ...decade('Fifth Decade (Reflection on God’s Promises)', 'Reflect on and thank God for His promises, trusting in His faithfulness.', DECADE_STONE_CYCLE_A, [
